...
public class GameMainFragment extends Fragment {
    ...
    public static String sContent_position= Constants.GAMES_MAINCONTENT;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ((HomeActivity)getActivity()).setmGameMainFragment(this);
            HomeActivity.isSearchClick = false;
            fragmentTransaction = getFragmentManager().beginTransaction();
            GamesListFragment gamesListFragment = new GamesListFragment();
            fragmentTransaction.replace(R.id.fragment_games_alllist, gamesListFragment);
    ...
    public void onDetach() {
        super.onDetach();
        ((HomeActivity)getActivity()).setmGameMainFragment(null);
