...
public class FragmentViewPagerItem extends Fragment {
    ...
    JSONArray mSliderArray;
    private AQuery aq;
    // TODO: Rename and change types and number of parameters
    public static FragmentViewPagerItem newInstance(String param1, String param2) {
        ...
        try {
            ...
            try
            {
                ...
                switch (list) {
                    case Constants.SPORTS:
                        mSliderArray = HomeActivity.m_jsonSportsSlider;
                        break;
                    case Constants.NETWORK:
                        if(HomeActivity.isPayperview.equals("Pay Per View")){
                            mSliderArray= HomeActivity.m_jsonSlider;
                        }else{
                            mSliderArray = HomeActivity.m_jsonShowSlider;
                        }

                        break;
                    case Constants.ALL_SIDE_MENU:
                        mSliderArray = HomeActivity.m_jsonHomeSlider;
                        break;
                    case Constants.PRIMETIMEANYTIME:
                        mSliderArray = HomeActivity.m_jsonPrimeTimeSlider;
                        break;
                    case Constants.CATEGORY_SHOW:
                        mSliderArray= HomeActivity.m_jsonCategorySlider;
                        break;
                    case Constants.WEB_ORIGINALS_SIDE_MENU:
                        mSliderArray= HomeActivity.m_jsonWebSlider;
                        break;
                    case Constants.KIDS:
                        mSliderArray= HomeActivity.m_jsonKidsSlider;
                        break;

                    case Constants.GAMES:
                        mSliderArray= HomeActivity.m_jsonGameSlider;
                        fragment_ondemand_all_pagercontent_watchnow_text.setText("PLAY NOW");
                        break;
                }
                ...
                for (int i = 0; i < mSliderArray.length(); i++) {
                    ...
                    slider_list.add(new SliderBean(id, description, title, image, name,type));
            ...
            fragment_ondemand_all_pagercontent_watchnow_text.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(!fragment_ondemand_all_pagercontent_watchnow_text.getText().equals("PLAY NOW"))
                    {
                        if(slider_list.get(Integer.parseInt(pos)).getType().equalsIgnoreCase("m")||slider_list.get(Integer.parseInt(pos)).getType().equalsIgnoreCase("movie")){
                        ...
                        new GetSliderEntity().execute(String.valueOf(slider_list.get(Integer.parseInt(pos)).getId()),String.valueOf(slider_list.get(Integer.parseInt(pos)).getType()));
                    ...
                    }else
                    {
                        ...
                        new GetGameSliderEntity().execute(String.valueOf(slider_list.get(Integer.parseInt(pos)).getId()));
    ...
    public class GetSliderEntity extends AsyncTask<String, Object, Object> {
        ...
        protected String doInBackground(String... params) {
            try {
                int nIndex = 1;
                if(params[1].equalsIgnoreCase("m")||params[1].equalsIgnoreCase("movie")){
                    m_jsonSlideEntity = JSONRPCAPI.getMovieSlideEntity(Integer.parseInt(params[0]));
                }else{
                    m_jsonSlideEntity = JSONRPCAPI.getSlideEntity(Integer.parseInt(params[0]));
                }
        ...
        protected void onPostExecute(Object params) {
            try {
                ...
                ((HomeActivity)getActivity()).mSlidertodeatails(m_jsonSlideEntity);
    ...
    public class GetGameSliderEntity extends AsyncTask<String, Object, Object> {
        ...
        protected String doInBackground(String... params) {
            try {
                int nIndex = 1;
                m_jsonSlideEntity = JSONRPCAPI.getGameSlideEntity(Integer.parseInt(params[0]));
                if (m_jsonSlideEntity  == null) return null;
                Log.d("Show::", "Selected Slider list::" + m_jsonSlideEntity);
            } catch (Exception e) {
                e.printStackTrace();
        ...
        protected void onPostExecute(Object params) {
            try {
                ...
                try {
                    ...
                    JSONObject data_object = new JSONObject(m_jsonSlideEntity.toString());

                    if (data_object.has("foreign_url")) {
                        url = data_object.getString("foreign_url");
